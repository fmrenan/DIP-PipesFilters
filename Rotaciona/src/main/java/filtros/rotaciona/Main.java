...
public class Main {
                    ...
                    case 1:
                        if(args[0].equalsIgnoreCase("/ajuda")){
                            ...
                            if(verificaEntrada(args[0])){
                                ...
                                img = new RotacionaDecorator(img, escala);
    ...
    private static void ajuda(){
        System.out.println("O filtro rotaciona realiza uma rotação na imagem de acordo com o ângulo passado no parâmetro \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     0 a 360 angulo aplicado na rotação");
        System.out.println("     Exemplo: rotaciona -v 60");
        System.out.println("     Exemplo2: rotaciona 180");
    }
