...
public class Main {
    public static void main(String args[]) {
        ...
        if(objeto.contains("erro")){
            ...
            try {
                ...
                switch (args.length) {
                    case 0:
                        img = new EspelhadaDecorator(img);
    ...
    private static void ajuda(){
        System.out.println("O filtro realiza o espelhamento da imagem entrada \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     Exemplo: espelhada -v");
        System.out.println("     Exemplo2: espelhada");
    }
