...
public class Main {
    ...
    private static void ajuda(){
        System.out.println("O filtro aplica o efeito sepia na imagem \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     Exemplo: sepia -v");
        System.out.println("     Exemplo2: sepia");
    }
