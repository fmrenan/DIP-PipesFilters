...
public class Main {
    ...
    private static void ajuda(){
        System.out.println("O filtro deixa a imagem com uma nitidez maior \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     Exemplo: nitidez -v");
        System.out.println("     Exemplo2: nitidez");
    }
