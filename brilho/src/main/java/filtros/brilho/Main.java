...
public class Main {
                    ...
                    case 1:
                        if(args[0].equalsIgnoreCase("/ajuda")){
                            ...
                            if(verificaEntrada(args[0])){
                                ...
                                img = new BrilhoDecorator(img, escala);
    ...
    private static void ajuda(){
        System.out.println("O filtro brilho realiza um brilho na imagem de acordo com o parametro digitado \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     1 até 5 recomendado para a intensidade do brilho aplicado");
        System.out.println("     Exemplo: brilho -v 3");
        System.out.println("     Exemplo2: brilho 2");
    }
