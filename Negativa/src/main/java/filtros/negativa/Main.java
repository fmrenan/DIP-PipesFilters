...
public class Main {
    ...
    private static void ajuda(){
        System.out.println("O filtro negativa transforma as cores da imagem em cores negativas \n");
        System.out.println("Parâmetros:");
        System.out.println("     -v utilizado quando deseja visualizar uma imagem que foi processada");
        System.out.println("     Exemplo: negativa -v");
        System.out.println("     Exemplo2: negativa");
    }
